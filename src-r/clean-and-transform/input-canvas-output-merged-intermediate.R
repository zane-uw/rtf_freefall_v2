# source this file to make wide weekly dataset from canvas files
...
# keep NAs to deal with later
lms_wkly_data <- xform_assignments() %>%
  full_join( xform_page_views() ) %>%
  full_join( xform_urls() )
